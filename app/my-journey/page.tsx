...
const Profile = async () => {
    ...
    const companions = await getUserCompanions(user.id, 10)

    return (
        <main className='min-lg:w-3/4'>
            <section className="flex justify-between gap-4 max-sm:flex-col items">
                <div className='flex gap-4 items-center'>
                    <Image
                        src={user.imageUrl || '/icons/avatar-default.svg'}
                        alt={user.firstName!}
                        width={150}
                        height={150}
